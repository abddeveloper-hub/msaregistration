/**
 * @fileoverview QRCode generator for JavaScript
 * @author davidshimjs
...
(function () {
    ...
    function _getUTF8Length(sText) {
        var replaceText = sText.replace(/[\u0080-\u07ff]/g, 'a').replace(/[\u0800-\uffff]/g, 'a');
        return replaceText.length;
    }

    QRCode = function (htOption) {
        this._htOption = {
            width: 256,
            height: 256,
            typeNumber: 4,
        ...
        if (typeof htOption == 'string') {
            htOption = { text: htOption };
        }
        if (htOption) {
            for (var i in htOption) {
                this._htOption[i] = htOption[i];
            }
        }
        this._oQRCode = null;
    };
